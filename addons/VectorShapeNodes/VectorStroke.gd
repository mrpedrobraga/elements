...
@export var end := 0.0 :
	set(v): set_end(v)
@export var use_data_nodes_width = false :
	set(v): set_use_data_nodes_width(v)
@export var use_data_nodes_color = false :
	set(v): set_use_data_nodes_color(v)
@export var use_close_fix = false :
	set(v): set_use_close_fix(v)
@export_range(0.0, 1.0) var start_pinch_length := 0.0 :
	set(v): set_start_pinch_length(v)
@export_range(0.0, 1.0) var end_pinch_length := 0.0 :
	set(v): set_end_pinch_length(v)
